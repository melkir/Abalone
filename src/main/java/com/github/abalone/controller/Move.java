            ...
            case DOWNLEFT:
                ...
                for (Ball b : this.initialBalls) {
                    if ((closest.getRow() < b.getCoords().getRow())
                            || (closest.getRow().equals(b.getCoords().getRow()) && closest
                            .getCol() > b.getCoords().getCol())) {
    ...
    private Set<Ball> validMove2(Board board) {
        ...
        switch (this.initialBalls.size()) {
            ...
            case 2:
                b1 = itb.next();
                b2 = itb.next();
                if (Typelignepl.lesDirectionPerpendiculaire(
                        b1.getCoords().LignePl(b2.getCoords())).contains(this.direction)) {
