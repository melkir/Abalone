...
public class GameController {
	...
	public Move validMove(Set<Coords> selectedBallsCoords, Direction direction,
			Color current) {
		Set<Ball> selectedBalls = this.game.getBoard().getLineColorBallsAt(
				selectedBallsCoords, current);
